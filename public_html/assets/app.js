...
function render(){
 ...
 const navItems=admin()?[['tasks','book','Задания'],['bank','bank','Банк заданий'],['builder','plus','Собрать ДЗ'],['students','users','Ученики'],['history','check','Выполненные']]:[['tasks','book','Мои задания'],['bank','bank','Банк заданий'],['classwork','grid','Классные работы'],['history','check','Выполненные']];
