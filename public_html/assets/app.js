...
function taskResults(){
 ...
 return `<div class="task-list">${shown.map(item=>item.members?groupCard(item.group_id,item.members):taskCard(item)).join('')}</div>`;
}
